...
function EmployeeHome() {
  ...
  const [filterType,  setFilterType]    = useState(() => sessionStorage.getItem("khata_employee_filter_type") || "all");
  const [sortType,    setSortType]      = useState(() => sessionStorage.getItem("khata_employee_sort_type") || "recent");
  ...
  useEffect(() => {
    sessionStorage.setItem("khata_employee_filter_type", filterType);
    sessionStorage.setItem("khata_employee_sort_type", sortType);
  }, [filterType, sortType]);
