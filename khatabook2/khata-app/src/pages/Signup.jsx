          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-12 py-4 rounded-2xl bg-slate-950/40 border border-white/8 hover:border-white/15 text-white placeholder-slate-600 focus:outline-none focus:border-emerald-500/50 transition-all duration-300 text-sm focus:bg-slate-950/60 focus:shadow-[0_0_15px_rgba(16,185,129,0.05)]"
                required
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition cursor-pointer outline-none p-1"
                tabIndex={-1}
              >
                {showPassword ? (
