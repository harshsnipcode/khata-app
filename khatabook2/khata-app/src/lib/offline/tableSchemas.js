...
export const TABLE_COLUMNS = Object.freeze({
  ...
  transactions: ["id", "customer_id", "type", "amount", "description", "payment_mode", "date", "created_by", "created_at", "activity_at", "import_history_id", "sync_operation_id"],
  transaction_items: ["id", "transaction_id", "product_id", "quantity", "price", "created_at", "sync_operation_id"],
  customer_product_prices: ["id", "customer_id", "product_id", "custom_price", "created_at", "updated_at"],
  product_transactions: ["id", "product_id", "type", "quantity", "price", "notes", "created_by", "created_at", "import_history_id"],
